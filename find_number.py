...
### taking con setup as in example for now....
...
# want to build a generator
# make an array of images from my individual pics  - build 2 one with Y one with N
# when done processing images - check len(Y matrix) and randomly sample N matrix
# batch size will be needed to work out how many pics to use
# feed gen into fit_generator
# do weights fit?
# softmax the output??
#